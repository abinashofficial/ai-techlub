...
export const AuthProvider: React.FC<{ children: ReactNode }> = ({ children }) => {
    ...
    return (
        <AuthContext.Provider value={{ isAuthenticated, empDetail, login, logout, setEmpDetail, setVisible, visible, setAnimations, animations, chat, setChat }}>
            {children}
